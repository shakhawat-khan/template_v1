...
const ApiResponseDbSchema = CollectionSchema(
  name: r'ApiResponseDb',
  id: 1623036950111429396,
  properties: {
...
extension ApiResponseDbQuerySortBy
  ...
  QueryBuilder<ApiResponseDb, ApiResponseDb, QAfterSortBy> sortByContent() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'content', Sort.asc);
    });
  }

  QueryBuilder<ApiResponseDb, ApiResponseDb, QAfterSortBy> sortByContentDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'content', Sort.desc);
    });
  }

  QueryBuilder<ApiResponseDb, ApiResponseDb, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<ApiResponseDb, ApiResponseDb, QAfterSortBy> sortByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ApiResponseDbQuerySortThenBy
  ...
  QueryBuilder<ApiResponseDb, ApiResponseDb, QAfterSortBy> thenByContent() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'content', Sort.asc);
    });
  }

  QueryBuilder<ApiResponseDb, ApiResponseDb, QAfterSortBy> thenByContentDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'content', Sort.desc);
    });
  }
  ...
  QueryBuilder<ApiResponseDb, ApiResponseDb, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<ApiResponseDb, ApiResponseDb, QAfterSortBy> thenByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.desc);
    });
  }
...
extension ApiResponseDbQueryWhereDistinct
  ...
  QueryBuilder<ApiResponseDb, ApiResponseDb, QDistinct> distinctByContent(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ApiResponseDb, ApiResponseDb, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ApiResponseDbQueryProperty
  ...
  QueryBuilder<ApiResponseDb, String, QQueryOperations> contentProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'content');
    });
  }

  QueryBuilder<ApiResponseDb, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
